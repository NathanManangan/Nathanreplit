...
InfoDb.append({  
 "FirstName": "Nathan",  
 "LastName": "Manangan",  
 "DOB": "06 February 2006",  
 "Residence": "4S Ranch",  
 "Email": "prorichyman@gmail.com",  
 "Family":["Nathan Manangan(me)","Kaila Manangan(sister)","Ian Manangan(brother)" "Raul Manangan(dad)", "Veronica Manangan(mom)"]
})

# given an index this will print InfoDb content
def print_data(n):
    print(InfoDb[n]["FirstName"], InfoDb[n]["LastName"])  # using comma puts space between values
    print("\t", "Family Members: ", end="")  # \t is a tab indent, end="" make sure no return occurs
    print(", ".join(InfoDb[n]["Family"]), end="")
    print(", "+ (InfoDb[n]["Email"]), end="")
    print(", "+ (InfoDb[n]["Residence"]), end="")
    print(", "+ (InfoDb[n]["DOB"]), end="")
